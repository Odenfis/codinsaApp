...
class EnterpriseDatabase {
  ...
  public modulos: Modulo[] = [
    ...
    { id_modulo: 6, nombre_modulo: 'Configuración', icono: 'Settings', ruta: '/settings', orden: 7, estado: true, children: [
      ...
      { id_modulo: 14, nombre_modulo: 'Nisira Export Direct', icono: 'FolderOutput', ruta: '/settings/nisira-export-direct', orden: 3, estado: true },
      { id_modulo: 15, nombre_modulo: 'Actualización ERP', icono: 'CloudDownload', ruta: '/settings/erp-update', orden: 4, estado: true }
    ] },
